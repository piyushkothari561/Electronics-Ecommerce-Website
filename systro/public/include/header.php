...
<nav class="navbar  navbar-expand-md navbar-dark bg-dark">
  <a class="navbar-brand text-success" href="index.php">Systro</a>
 ...
 <!-- Home button -->
 <li class="nav-item">
        <a class="nav-link" href="index.php"><span class="fa fa-home"></span></i> Home</a>
      </li>
<!-- Dropdown button -->
  ...
  <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
   ...
   {
      ?>  <form action="product_search.php" role="form" method="post">
...
echo "<form action=\"product_search.php\" role=\"form\" method=\"post\">\n";
...
<ul class="nav navbar-nav">
            <li class="nav-item text-center" id="signup-btn">
                <a href="user_registration.php" class="nav-link" ><span class="fa fa-user"></span><span class="d-none d-sm-inline d-xl-block px-1">Sign Up</span></a>
            </li>
            <li class="nav-item text-center" id="login-btn">
                <a href="login.php" class="nav-link" ><span class="fa fa-sign-in"></span><span class="d-none d-sm-inline d-xl-block px-1">Log In</span></a>
            </li>
            <li class="nav-item text-center" id="login-btn">
