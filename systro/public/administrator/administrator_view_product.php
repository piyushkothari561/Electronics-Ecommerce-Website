...
?>
<!------------------------------------------------------------------------------------------------------------------------------>
<?php require_once $_SERVER["DOCUMENT_ROOT"] . "/administrator/include/administrator_header.php"?>
<?php require_once $_SERVER["DOCUMENT_ROOT"] . "/administrator/include/administrator_sidebar.php"?>
...
<div class="jumbotron">
 <div class="container rounded">
    <form action="administrator_view_product.php" role="form" class="form-inline" method="post">
			...
			<div class="col-md-3 col-6  product-grid">
			    <div class="image imagear">
                    ...
                    ?>
                        ...
                        <a class="productdetail btn"  type="submit" href="modify_product.php?product_id=<?php echo $product_data['product_id'] ?>" >View Product</a>
						</div>
                    </a >
			    </div>
...
<!----------------------------------------------------------------------------------------------------------------------------->
<?php  require_once $_SERVER["DOCUMENT_ROOT"] . "/administrator/include/administrator_footer.php"?>
<!------------------------------------------------------------------------------------------------------------------------------>
<?php
}
